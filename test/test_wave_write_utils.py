...
def test_wave_write_test():
    wave_path = os.path.dirname(__file__)+os.path.sep+'xears'+os.path.sep+'data_source'+os.path.sep+'test30n.wav'
    ...
    B_path = os.path.dirname(__file__)+os.path.sep+'xears'+os.path.sep+'data_source'+os.path.sep+'test30.wav'
    wave_data,time = wave_utils.readWav(B_path)
    #print(wave_data)
    noise_data = wave_utils.gen_noise_wave(wave_data)
    #print(noise_data)
    #wave_utils.drawWave(noise_data,time)
    wave_utils.writeWav(noise_data,params,wave_path)
